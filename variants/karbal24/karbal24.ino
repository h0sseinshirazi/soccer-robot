...
void MoveInSide() {
  if (ldr_R > ldrSens) motor(-30000 + GY, 30000 + GY, 30000 + GY, -30000 + GY);
  else if (ldr_L > ldrSens) motor(30000 + GY, -30000 + GY, -30000 + GY, 30000 + GY);
  else if (ldr_B > ldrSens) motor(30000 + GY, 30000 + GY, -30000 + GY, -30000 + GY);
...
void AI2() {
  ...
  if (tsop < 3000) {
      ...
      if (num == 0) move0: 
      else if ((num <= 4 && num >= 1 )&& shr < 1200){
         move(4);
         head = head ;
         }
      else if ((num >= 12 && num <= 15)&& shl < 1200){ 
        move(12);
        head = head ;
    }
  }   
  else {
    if (shb > 1500)          motor(-e + 30000 + GY, e + 30000 + GY, e - 30000 + GY, -e - 30000 + GY);
    else if (shb < 1200)     motor(-e - 30000 + GY, e - 30000 + GY, e + 30000 + GY, -e + 30000 + GY);
    else if (shr > 1200 && tsop > 3000) move(12);
    else if (shl > 1300 && tsop > 3000) move(4);
